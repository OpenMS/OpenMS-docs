...
View the [cmake website](https://cmake.org) for more information.
...
Windows (Visual studio console): See [Dependency Walker](https://www.dependencywalker.com/) (use x86 for 32 bit builds
...
For more information see the [`valgrind` documentation](https://valgrind.org/docs/manual/) .
